...
class PengembalianBukuController extends Controller
{
    ...
    {
        $data = PengembalianBuku::with('buku', 'murid')->get();
    ...
    public function store(Request $request)
    {
        ...
        $data->id = $request->id; // di tambahkan sendiri
    ...
    {
        $data = PengembalianBuku::with('buku', 'murid')->find($id);
        if ($data) {
            return response()->json([
                'status' => true,
                'message' => 'Data Di Temukan',
