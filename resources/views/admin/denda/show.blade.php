          ...
          <div class="card-body">
            ...
            <div>
              <div class="row mb-3">
                ...
                <div class="col-sm-8">                
                  <b>{{ $pengembalian_buku['murid']['nama'] }}</b>
                </div>
              </div>
              <div class="row mb-3">
            ...
            <div class="card">
              <div class="card-body">
               ...
               @endphp
                  ...
                  @endif --}}
                  <div class="row mb-3">
                    <label for="inputPassword3" class="col-sm-4 col-form-label"><a href="{{url('admin/denda')}}" class="btn btn-primary">Kembali</a></label>        
                  </div> 
...
@endsection@extends('template.admin.index')
@section('content_admin')
