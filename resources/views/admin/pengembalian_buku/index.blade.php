...
<div class="col-12">
    <div class="card recent-sales overflow-auto">
      <div class="card-body">
        <h5 class="card-title">Data Pengembalian Buku <span>| Tambahkan Data</span></h5>
        @if ($errors->any())
            <ul>
        ...
        <table class="table table-borderless datatable">
          ...
          <tbody>
            ...
            @endphp
                  ...
                  <td>
                    {{-- <a href="{{url('admin/pengembalian_buku/edit/'.$value['id'])}}" data-bs-toggle="modal" data-bs-target="#EditModal{{$value['id']}}" class="btn btn-info btn-sm"><i class="bi bi-pencil"></i>Edit</a> --}}
                    <a href="{{url('admin/pengembalian_buku/show/'.$value['id'])}}" class="btn btn-info btn-sm"><i class="bi bi-eye"></i>Detail</a>
                    {{-- <form action="{{url('admin/pengembalian_buku/delete/'.$value['id'])}}" method="POST" onsubmit="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" class="d-inline">
                      @csrf
                      @method('delete')
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title">Edit Data Pengembalian Buku</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form action="{{url('admin/pengembalian_buku/update/'.$value['id'])}}"  method="post">
                      @csrf
                      @method('PUT')
                      <div class="col-12">
  ...
  <div class="modal fade" id="createModal" tabindex="-1">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">Tambah Data Pengembalian Buku</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="{{url('admin/pengembalian_buku/create')}}"  method="post">
            @csrf
            <div class="col-12">
              <label for="yourUsername" class="form-label">Buku</label>
              <div class="input-group has-validation">
