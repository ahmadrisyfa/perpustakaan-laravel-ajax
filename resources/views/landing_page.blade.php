    ...
    <main>
        <div class="container">
            ...
            <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
                <h2>PERPUSTAKAAN</h2>
                <h3 class="text-center">Selamat Datang Di Perpustakaan SMK Pembangunan</h3>
                <div class="row mt-4">
                    @auth
                    <div class="col-6">
                ...
                <img src="{{asset('template_admin')}}/assets/img/logos.png" class="img-fluid py-5" alt="Page Not Found">
                <div class="credits">
