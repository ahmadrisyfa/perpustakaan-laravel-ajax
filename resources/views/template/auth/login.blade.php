...
<body>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <span class="d-none d-lg-block">Perpustakaan SMK Pembangunan</span>
                            </a>
                        </div> --}}
                        <!-- End Logo -->
                        <img style="height: 300px; width: 200px;" src="{{asset('template_admin')}}/assets/img/logos.png" class="img-fluid py-5" alt="Page Not Found">
                        <div class="card mb-3">
                        ...
                        <div class="credits">
                            ...
                            {{-- Designed by <a href="{{url('/')}}">Pertpustakan</a> --}}
                        </div>
    ...
    <a href="{{asset('template_admin')}}/#" class="back-to-top d-flex align-items-center justify-content-center"><i class="bi bi-arrow-up-short"></i></a>
